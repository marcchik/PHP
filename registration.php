...
<div class="cont">
    <form action = "reg.php" method="post">
        <fieldset>
            ...
            <p>Имя:    <input name="name" class = "form-control"></p>
            <p>Фамилия:    <input name="surname" class = "form-control"></p>
            <p>Логин:    <input name="login" class = "form-control"></p>
            <p>Введите пароль: <input type="password" class = "form-control" name="pass"></p>
            <p>Подтвердите пароль: <input type="password" class = "form-control" name="pass2"></p>
            <p><input type="submit" class = "btn btn-success" value="Подтвердить">
            </p>
        </fieldset>
    </form>
</div>
